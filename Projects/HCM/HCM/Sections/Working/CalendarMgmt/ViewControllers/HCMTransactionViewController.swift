//
//  HCMTransactionViewController.swift
//  HCM
//
...
class HCMTransactionViewController: UITableViewController {
    ...
    func loadEvent() {
        ...
        items = HCMEventKitUtil.fetchTransactionsFrom(startDate, to: endDate)
    }
